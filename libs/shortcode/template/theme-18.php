		 ...
		 if($review_testimonial_grid_type == 1){
		 	if($review_testimonial_grid_style == 1){?>
				<style type="text/css">
					...
					.testimonialreview-<?php echo esc_attr( $postid );?> .testimonialreview-author-info {
					    display: block;
					}
					.testimonialreview-<?php echo esc_attr( $postid );?> .testimonialreview-author-thumb {
						margin-bottom: 10px;
					}
					.testimonialreview-<?php echo esc_attr( $postid );?> .testimonialreview-author-thumb > img {
						width: 80px;
						height: auto;
						border-radius: 50%;
						overflow: hidden;
					}
					.testimonialreview-<?php echo esc_attr( $postid );?> .testimonialreview-author-name{
					...
					.testimonialreview-<?php echo esc_attr( $postid );?> .testimonialreview-author-name span.testimonialreview-desigation{
					...
					.testimonialreview-<?php echo esc_attr( $postid );?> .testimonialreview-urls,
					.testimonialreview-<?php echo esc_attr( $postid );?> .testimonialreview-urls a {
						outline: none;
					...
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonial-review-icons {
					    display: block;
					    overflow: hidden;
					}
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonial-review-icons i.fa {
					    font-size: 30px;
					    margin-bottom: 10px;
					    color: <?php echo $review_items_text_color;?>;
					}
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonial-review-description {
						margin-bottom: 15px;
					}
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonial-review-description p{
						margin:0;
						color: <?php echo $review_items_text_color;?>;
					...
					<?php while ( $review_query->have_posts() ) : $review_query->the_post();
						...
						<div class="reviewtestimonial-col-lg-<?php echo $review_testimonial_columns;?> reviewtestimonial-col-md-2 reviewtestimonial-col-sm-2 reviewtestimonial-col-xs-1">
							<div class="testimonialreview-single-items-<?php echo esc_attr( $postid );?>">
								<div class="testimonialreview-items-info-<?php echo esc_attr( $postid );?>">
									<div class="single-testimonial-review-icons">
								...
								<div class="testimonialreview-author-info">
									<div class="testimonialreview-author-thumb">
										<img src="<?php echo $ppoint_thumb;?>" alt="<?php echo the_title();?>" />
									</div>
									<div class="testimonialreview-title-area">
										<div class="testimonialreview-author-name">
