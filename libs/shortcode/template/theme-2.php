		 ...
		 if($review_testimonial_grid_type == 1){
		 	if($review_testimonial_grid_style == 1){?>
				<style type="text/css">
					...
					.testimonialreview-<?php echo esc_attr( $postid );?> .testimonialreview-single-items-<?php echo esc_attr( $postid );?> {
						display: block;
						overflow: hidden;
						margin-bottom: 0px;
					...
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonialreview-info {
						display: flex;
						align-items: center;
						justify-content: center;
					}
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonialreview-thumb {
					    margin-right: 15px;
					    width: 80px;
					    height: auto;
					    border-radius: 50%;
					...
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonialreview-thumb img {
						width: 100%;
					}
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonialreview-title {
						display: block;
						overflow: hidden;
						margin-bottom: 12px;
					...
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonialreview-title-area .testimonialreview-name {
					...
					.testimonialreview-<?php echo esc_attr( $postid );?> .single-testimonialreview-title-area .testimonialreview-name span.testimonialreview-desigation{
